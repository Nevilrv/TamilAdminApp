...
class AppNotificationHandler {
  ...
  static Future getFcmToken() async {
    ...
    try {
      ...
      log('FCM-TOKEN---${storage.read('fcm')}');
      return token;
    } catch (e) {
      log("=========fcm- Error :$e");
      return null;
  ...
  static Future<bool?> sendMessage({
    ...
    var serverKey =
        'AAAApNSMwAI:APA91bFjA4FeYLxu9caF8mbfZOJks-hjEA9I8q7KdwupoHnnKolif6hfGjrrEFA_p5Kymtuz--8yCYoKsFC4MoDbMkKHErooE3rd8ST5mozLj13I5yjgcfzBbplrOdW0YIvXAZdPFT5d';
    try {
